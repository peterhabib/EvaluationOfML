...
EvalFile = open('EvaluationFile(Normalized).csv','w')
...
EvalFile.write('algorithm\talgorithm_scoring\tmean_absolute_error\tmean_squared_error\tr2_score\thomogeneity_score\tadjusted_rand_score\tv_measure_score\n')
